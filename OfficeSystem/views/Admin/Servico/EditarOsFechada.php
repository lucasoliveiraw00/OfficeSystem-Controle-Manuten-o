                    ...
                    <div class="col-5">
                            ...
                            <div class="col-sm-12">
                                <div class="row">
                                    <div class="form-group col-md-5">
                                        <label for="nome">Data:</label>
                                        <input type="text" class="form-control" name="dataFechamento" id="dataFechamento" required readonly value="<?php echo $ResultDados['dataFechamento']; ?>">
                                        <span class="hidden msg-error invalido-dataFechamento">Preencher o Campo Data Fechamento.
                                    </div>
                                    <div class="form-group col-md-5">
                                        <label for="nome">Hora:</label>
                                        <input type="text" class="form-control" name="horaFechamento" id="horaFechamento"  required readonly value="<?php echo $ResultDados['horaFechamento']; ?>">
